...
IncludePackagePath     :=
IncludeCPath           := $(IncludeSwitch)D:/PROJECT/APT32F102A_FOLDER/CODE/bootloader/Source/include $(IncludeSwitch)../Source/include  
...
$(IntermediateDirectory)/FWlib_apt32f102_crc$(ObjectSuffix): ../Source/FWlib/apt32f102_crc.c  
	$(CC) $(SourceSwitch) ../Source/FWlib/apt32f102_crc.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/FWlib_apt32f102_crc$(ObjectSuffix) -MF$(IntermediateDirectory)/FWlib_apt32f102_crc$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/FWlib_apt32f102_crc$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/FWlib_apt32f102_crc$(PreprocessSuffix): ../Source/FWlib/apt32f102_crc.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/FWlib_apt32f102_crc$(PreprocessSuffix) ../Source/FWlib/apt32f102_crc.c
...
$(IntermediateDirectory)/FWlib_apt32f102_sio$(ObjectSuffix): ../Source/FWlib/apt32f102_sio.c  
	$(CC) $(SourceSwitch) ../Source/FWlib/apt32f102_sio.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/FWlib_apt32f102_sio$(ObjectSuffix) -MF$(IntermediateDirectory)/FWlib_apt32f102_sio$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/FWlib_apt32f102_sio$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/FWlib_apt32f102_sio$(PreprocessSuffix): ../Source/FWlib/apt32f102_sio.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/FWlib_apt32f102_sio$(PreprocessSuffix) ../Source/FWlib/apt32f102_sio.c

$(IntermediateDirectory)/FWlib_apt32f102_spi$(ObjectSuffix): ../Source/FWlib/apt32f102_spi.c  
	$(CC) $(SourceSwitch) ../Source/FWlib/apt32f102_spi.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/FWlib_apt32f102_spi$(ObjectSuffix) -MF$(IntermediateDirectory)/FWlib_apt32f102_spi$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/FWlib_apt32f102_spi$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/FWlib_apt32f102_spi$(PreprocessSuffix): ../Source/FWlib/apt32f102_spi.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/FWlib_apt32f102_spi$(PreprocessSuffix) ../Source/FWlib/apt32f102_spi.c
...
$(IntermediateDirectory)/source_Ht1621$(ObjectSuffix): source/Ht1621.c  
	$(CC) $(SourceSwitch) source/Ht1621.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/source_Ht1621$(ObjectSuffix) -MF$(IntermediateDirectory)/source_Ht1621$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/source_Ht1621$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/source_Ht1621$(PreprocessSuffix): source/Ht1621.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/source_Ht1621$(PreprocessSuffix) source/Ht1621.c

$(IntermediateDirectory)/source_key$(ObjectSuffix): source/key.c  
	$(CC) $(SourceSwitch) source/key.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/source_key$(ObjectSuffix) -MF$(IntermediateDirectory)/source_key$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/source_key$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/source_key$(PreprocessSuffix): source/key.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/source_key$(PreprocessSuffix) source/key.c

$(IntermediateDirectory)/source_disp$(ObjectSuffix): source/disp.c  
	$(CC) $(SourceSwitch) source/disp.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/source_disp$(ObjectSuffix) -MF$(IntermediateDirectory)/source_disp$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/source_disp$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/source_disp$(PreprocessSuffix): source/disp.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/source_disp$(PreprocessSuffix) source/disp.c
